...
const releaseId = process.env.NOOLCODE_RELEASE
if (!releaseId) throw new Error("NOOLCODE_RELEASE is required")

const version = process.env.NOOLCODE_VERSION
if (!releaseId) throw new Error("NOOLCODE_VERSION is required")
