          ...
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://noolcode.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <p>
                ...
                our site located at noolcode.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                ...
                click here{" "}
                <a href="https://noolcode.ai/legal/privacy-policy">https://noolcode.ai/legal/privacy-policy</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://noolcode.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://noolcode.ai/auth">https://noolcode.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://noolcode.ai/legal/privacy-policy</a>, as well
