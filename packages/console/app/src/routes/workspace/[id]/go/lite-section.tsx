...
import { Database, eq, and, isNull } from "@noolcode/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@noolcode/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#noolcode-go")} target="_blank" rel="noopener noreferrer">
