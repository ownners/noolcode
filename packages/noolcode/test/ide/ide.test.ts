...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders NOOLCODE_CALLER", () => {
    process.env["NOOLCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode NOOLCODE_CALLER", () => {
    process.env["NOOLCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown NOOLCODE_CALLER", () => {
    process.env["NOOLCODE_CALLER"] = "unknown"
