...
import { ResizeHandle } from "@noolcode/ui/resize-handle"
...
import { Session, type Message } from "@noolcode/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@noolcode/ui/toast"
...
import { useTheme, type ColorScheme } from "@noolcode/ui/theme"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://noolcode.ai/desktop-feedback")}
      renderPanel={() =>
        mobile ? (
