...
export const dict = {
  ...
  "dialog.provider.noolcode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.noolcode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.noolcodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "provider.connect.noolcodeZen.line2":
    "Tek bir API anahtarıyla Claude, GPT, Gemini, GLM ve daha fazlası gibi modellere erişebilirsiniz.",
  "provider.connect.noolcodeZen.visit.prefix": "",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
