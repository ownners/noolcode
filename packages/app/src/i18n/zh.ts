...
export const dict = {
  ...
  "dialog.provider.noolcode.note": "使用 OpenCode Zen 或 API 密钥连接",
  "dialog.provider.noolcode.tagline": "可靠的优化模型",
  "dialog.provider.noolcodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect.noolcodeZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.noolcodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.noolcodeZen.visit.prefix": "访问 ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " 获取你的 API 密钥。",
