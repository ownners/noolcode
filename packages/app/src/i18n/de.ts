...
export const dict = {
  ...
  "dialog.provider.noolcode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.noolcode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.noolcodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "provider.connect.noolcodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
