export const dict = {
  ...
  "dialog.provider.noolcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.noolcode.tagline": "Reliable optimized models",
  "dialog.provider.noolcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.noolcodeZen.visit.prefix": "Visit ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " to collect your API key.",
