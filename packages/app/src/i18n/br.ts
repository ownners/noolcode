export const dict = {
  ...
  "dialog.provider.noolcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.noolcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.noolcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "provider.connect.noolcodeZen.visit.prefix": "Visite ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " para obter sua chave de API.",
