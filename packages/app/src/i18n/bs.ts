export const dict = {
  ...
  "dialog.provider.noolcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.noolcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.noolcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "provider.connect.noolcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
