export const dict = {
  ...
  "dialog.provider.noolcode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.noolcode.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.noolcodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.noolcodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.noolcodeZen.visit.prefix": " ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "noolcode.jsonで設定されたプラグイン",
