export const dict = {
  ...
  "dialog.provider.noolcode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.noolcode.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.noolcodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.noolcodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
