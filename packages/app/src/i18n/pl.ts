export const dict = {
  ...
  "dialog.provider.noolcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.noolcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.noolcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.noolcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
