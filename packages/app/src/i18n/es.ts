export const dict = {
  ...
  "dialog.provider.noolcode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.noolcode.tagline": "Modelos optimizados y fiables",
  "dialog.provider.noolcodeGo.tagline": "Suscripción económica para todos",
  ...
  "provider.connect.noolcodeZen.visit.prefix": "Visita ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " para obtener tu clave API.",
