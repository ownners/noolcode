...
export const dict = {
  ...
  "dialog.provider.noolcode.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.noolcode.tagline": "可靠的優化模型",
  "dialog.provider.noolcodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.noolcodeZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.noolcodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.noolcodeZen.visit.prefix": "造訪 ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " 取得你的 API 金鑰。",
