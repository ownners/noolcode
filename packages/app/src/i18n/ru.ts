export const dict = {
  ...
  "dialog.provider.noolcode.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.noolcode.tagline": "Надежные оптимизированные модели",
  "dialog.provider.noolcodeGo.tagline": "Доступная подписка для всех",
  ...
  "provider.connect.noolcodeZen.visit.prefix": "Посетите ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " чтобы получить ваш API ключ.",
