export const dict = {
  ...
  "dialog.provider.noolcode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.noolcode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.noolcodeGo.tagline": "Billigt abonnement for alle",
  ...
  "provider.connect.noolcodeZen.visit.prefix": "Besøg ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " for at hente din API-nøgle.",
