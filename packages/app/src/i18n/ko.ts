...
export const dict = {
  ...
  "dialog.provider.noolcode.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.noolcode.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.noolcodeGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "provider.connect.noolcodeZen.line1":
    "OpenCode Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  "provider.connect.noolcodeZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.noolcodeZen.visit.prefix": "다음 ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "dialog.plugins.empty": "noolcode.json에 구성된 플러그인",
