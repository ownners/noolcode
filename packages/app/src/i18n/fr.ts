export const dict = {
  ...
  "dialog.provider.noolcode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.noolcode.tagline": "Modèles optimisés et fiables",
  "dialog.provider.noolcodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "provider.connect.noolcodeZen.visit.prefix": "Visitez ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " pour récupérer votre clé API.",
