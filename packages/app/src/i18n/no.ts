...
export const dict = {
  ...
  "dialog.provider.noolcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.noolcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.noolcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "provider.connect.noolcodeZen.visit.prefix": "Besøk ",
  "provider.connect.noolcodeZen.visit.link": "noolcode.ai/zen",
  "provider.connect.noolcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
