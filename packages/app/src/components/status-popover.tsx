...
import { Popover } from "@noolcode/ui/popover"
import { Switch } from "@noolcode/ui/switch"
...
export function StatusPopover() {
  ...
  const pluginEmpty = createMemo(() => pluginEmptyMessage(language.t("dialog.plugins.empty"), "noolcode.json"))
