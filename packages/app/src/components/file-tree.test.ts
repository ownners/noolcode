...
beforeAll(async () => {
  ...
  mock.module("@noolcode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@noolcode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@noolcode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@noolcode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
