import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@noolcode/sdk/v2"
import { SessionTurn } from "@noolcode/ui/session-turn"
import { SessionReview } from "@noolcode/ui/session-review"
import { DataProvider } from "@noolcode/ui/context"
import { FileComponentProvider } from "@noolcode/ui/context/file"
import { WorkerPoolProvider } from "@noolcode/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@noolcode/ui/logo"
import { IconButton } from "@noolcode/ui/icon-button"
import { ProviderIcon } from "@noolcode/ui/provider-icon"
import { iife } from "@noolcode/util/iife"
...
import { Tabs } from "@noolcode/ui/tabs"
import { MessageNav } from "@noolcode/ui/message-nav"
import { FileSSR } from "@noolcode/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@noolcode/ui/pierre/worker").then((m) => ({
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              ...
                              <IconButton
                                as={"a"}
                                href="https://noolcode.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
