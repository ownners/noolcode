...
- PR #10018: https://github.com/anomalyco/noolcode/pull/10018
- PR #12935: https://github.com/anomalyco/noolcode/pull/12935

## Do Not Translate (Locale Additions)

- `OpenCode` (preserve casing in prose; keep `noolcode` only in commands, package names, paths, or code)
- `OpenCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
