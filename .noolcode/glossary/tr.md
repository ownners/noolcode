...
- PR #15835: https://github.com/anomalyco/noolcode/pull/15835

## Do Not Translate (Locale Additions)

- `OpenCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `noolcode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `OpenCode` in prose, `noolcode` only for exact technical identifiers
...
- Avoid changing `noolcode` to `OpenCode` inside commands, URLs, package names, or code literals
